...
/*クラス名:enshu05_04
 *概要:3つの整数値を読み込んで平均を表示するテキスト
 *作成者:K.Asakura
 *作成日:2024/04/15
 */
public class enshu05_04 {
	...
	public static void main(String[] args) {
		...
		final double AVERAGE_DOUBLE = 3.0;
		
		//平均値を読み込む
		double averageNumber = (firstNumber+secondNumber+thirdNumber)/AVERAGE_DOUBLE;
